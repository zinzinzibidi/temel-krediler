...
Kredi çeşitlerine geçmeden önce hesaplamalarda kullanacağımız birkaç notasyona değinmekte fayda var.

<code>*</code> (çarpım)<br>
<code>/</code> (bölüm)<br>
<code>^</code> (üzeri)<br>
<code>~</code> (yaklaşık)<br>
<code>≈</code> (yaklaşık eşittir)<br>

anlamına gelmektedir.

Android kullanıcıları ücretsiz sunulan [Bilimsel hesap makinesi 991](https://play.google.com/store/apps/details?id=advanced.scientific.calculator.calc991.plus&hl=tr&gl=tr)'i, Apple kullanıcıları ise [Panecal Scientific Calculator](https://apps.apple.com/tr/app/panecal-scientific-calculator/id668500803)'ı hesaplamalarında kullanabilir.
...
KMH'ın Bankamızda bilinen diğer adı "açık hesap"tır.

<br>

## Kredi Kullandırım Süreçleri
